...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2025 a las 00:10:58
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('admin','vendedor','cajero') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `pagos`
  ...
  ADD CONSTRAINT `pagos_ibfk_2` FOREIGN KEY (`id_cajero`) REFERENCES `usuarios` (`id_usuario`);

--
-- Filtros para la tabla `pedidos`
--
ALTER TABLE `pedidos`
  ADD CONSTRAINT `pedidos_ibfk_1` FOREIGN KEY (`id_vendedor`) REFERENCES `usuarios` (`id_usuario`),
